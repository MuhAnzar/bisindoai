"""
Valid Labels Evaluation - Menggunakan hanya labels BISINDO yang valid
"""
...
def create_valid_test_dataset():
    """Buat test dataset hanya dengan labels yang valid"""
    valid_labels = get_valid_bisindo_labels()
    
    return [
        # Test cases dengan labels valid
        {
